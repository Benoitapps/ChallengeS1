 ...
 */
final class Version20230201134605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE composition (id INT NOT NULL, nb_adult INT DEFAULT NULL, nb_child INT DEFAULT NULL, nb_animals INT DEFAULT NULL, prix NUMERIC(10, 0) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE reservation (id INT NOT NULL, by_id INT DEFAULT NULL, composition_id INT NOT NULL, country_id INT NOT NULL, company_id INT DEFAULT NULL, prix NUMERIC(10, 0) NOT NULL, PRIMARY KEY(id))');
