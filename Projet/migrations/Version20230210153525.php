 ...
 */
final class Version20230210153525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE place (id INT NOT NULL, acheteur_id INT DEFAULT NULL, reservation_id INT DEFAULT NULL, nb INT DEFAULT NULL, PRIMARY KEY(id))');
