 ...
 */
final class Version20230218192035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT NOT NULL, name VARCHAR(255) NOT NULL, company_verified BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
